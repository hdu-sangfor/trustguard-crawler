# Vue涉及国家安全漏洞？ 尤雨溪回应：前端框架没有渗透功能 - InfoQ

### 来源信息
- **URL**: https://www.infoq.cn/article/YbaZecBM65FPWmPsmlXL
- **域名**: www.infoq.cn
- **检索关键词**: 开源软件 安全治理
- **页面抓取**: 成功

### 搜索摘要
有者和维护者）、 Oracle（Log4j 库运行所在的 Java 软件平台的所有者）、GitHub 和 Linux 开源基金会等等，共同讨论开源软件的安全性。 开源软件安全问题不应被忽视.
